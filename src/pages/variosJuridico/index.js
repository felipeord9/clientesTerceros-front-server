            ...
            <div className="d-flex flex-column">
              <center>
                <Fade cascade="true">
                  ...
                  >
                    <strong>
                      PROVEEDORES VARIOS (AGENCIAS) - persona JURÍDICA
                    </strong>
                  </label>
                </Fade>
                <hr className="my-1" />
          ...
          <div className="bg-light rounded shadow-sm p-3 mb-3">
            <div className="d-flex flex-column gap-1">
              <div>
                ...
                <div className="w-100 d-flex justify-content-center text-align-center mb-2">
                  <label
                ...
                <div className="d-flex flex-row mt-2 mb-2">
                  ...
                  <div className="d-flex flex-column mb-2  w-100">
                    <label className="fw-bold me-1" style={{ fontSize: 16 }}>
                      SOLICITANTE:
                    </label>
                    <input
                      id="solicitante"
                ...
                <div className="d-flex flex-row mt-2 mb-2 me-3">
                  <div className="d-flex flex-row align-items-start w-100">
              ...
              <label className="fw-bold mt-0" style={{ fontSize: 20 }}>
