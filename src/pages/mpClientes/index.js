  ...
  return (
    ...
    >
      <div className="rounder-4">
        ...
        <div
          className="login-wrapper pt-2 mb-2 shadow-lg border-light rounded-4 border border-3 bg-gradient d-flexjustify-content-between "
