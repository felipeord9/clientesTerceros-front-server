...
export default function VariosNatural() {
  ...
  const [agencia] = useState(null);
  const [document] = useState(null);
  const [ciudad] = useState(null);
  const [departamento] = useState("");
  const [actividad] = useState(null);
              ...
              <center>
                <Fade cascade="true">
                  <label
                    ...
                    style={{ fontSize: 100 }}
                  >
                    <strong>PRE - APROBACIÓN DE CREDITOS</strong>
                  </label>
                </Fade>
              </center>
              <hr className="my-1" />
          ...
          <div className="bg-light rounded shadow-sm p-3 mb-3">
            <div className="d-flex flex-column gap-1">
              <center>
                <div className="d-flex flex-column">
                  <label>
                    Se realiza un estudio del cliente, <strong>{}</strong> Con
                    NIT: <strong>{}</strong>,
                  </label>
                  <label>
                    en donde nos arroja la siguiente información financiera
                  </label>
