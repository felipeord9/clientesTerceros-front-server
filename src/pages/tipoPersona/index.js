  ...
  return (
    ...
    >
      <div className="rounder-4">
        <div
          className="login-wrapper p-2 mb-3 shadow-lg border-light rounded-4 border border-3 bg-gradient d-flexjustify-content-between "
          style={{ backgroundColor: "white", userSelect: "none" }}
        >
          <Fade cascade damping={0.1} direction="down" triggerOnce="true">
            <div className="w-100 " style={{ backgroundColor: "red" }}></div>
            <div>
            ...
            <h1>
              ...
              <strong className="text-danger">
                Proveedor Mcia y Convenios
              </strong>
            </h1>
            <hr style={{ width: 600, color: "black" }} />
          </Fade>

          <Fade cascade>
            <h3 style={{ userSelect: "none" }} className="pt-2">
              ¿A qué <strong className="text-danger">tipo de persona</strong> se
              le llevará a cabo el proceso?
            </h3>
          </Fade>
          <div className="w-100 d-flex flex-row">
            <div className="d-flex flex-column" style={{ width: 240 }}>
              <div className="" style={{ height: 78 }}></div>
              <div className="w-100" style={{}}>
                <Button
                  onClick={(e) => handleClickBack(e)}
                  variant="contained"
                  className="d-flex justify-content-start pms-1"
                >
