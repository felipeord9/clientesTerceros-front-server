      ...
      <div className="rounder-4">
        <div className="login-wrapper d-flex flex-column mt-5 pt-3">
          <h1 className="text-danger fw-bold">
            Información de Tercero y Generación de Certificados
          </h1>
          <div className="d-flex flex-column gap-2 h-100 ">
            <div
              className="d-flex flex-column rounded rounded-3 p-1 border border-2"
            ...
            <TableCertificados
              ...
              loading={loading}
              ciudad={ciudades.map((item) => item.description)}
              style={{ fontSize: 20 }}
            />
          </div>
        </div>
