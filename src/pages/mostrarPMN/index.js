...
export default function MostrarPMN() {
  ...
  return (
    ...
    >
      <div style={{ height: 820 }}></div>
      <div
        className=" login-wrapper shadow rounded-4 border border-3 p-2 pb-3 mb-5 h-auto overflow-auto"
      ...
      >
        ...
        >
          {isMobile && <div className="d-flex" style={{ height: 50 }}></div>}
          <Button
            style={{ height: 35 }}
          ...
          <button
            ...
            onClick={(e) => navigate("/editar/info/PMN")}
            style={{
