...
import { deleteProveedor, sendMail } from "../../services/proveedorService";
...
export default function Parqueaderos() {
  ...
  const [docVinculacion] = useState(0);
                ...
                <Fade cascade="true">
                  {user.role === "cartera" ? (
                    <label
                      ...
                      style={{ fontSize: 100 }}
                    >
                      <strong>CLIENTES OCASIONALES</strong>
                    </label>
                  ) : (
                    <label
                      className="fs-3 fw-bold m-1 ms-4 me-4 text-danger mb-2"
                      style={{ fontSize: 100 }}
                    >
                      <strong>CENTROS COMERCIALES Y PARQUEADEROS</strong>
                    </label>
                  )}
                  <label
                    className=" m-1 ms-4 me-4 mb-2 mt-0"
                    style={{ fontSize: 20 }}
                  >
