...
export default function MostartPNC() {
      ...
      >
        ...
        >
          ...
          <button
            ...
            onClick={(e) => navigate("/editar/info/PNC")}
            style={{
          ...
          <div className="row row-cols-sm-4 mt-2 mb-2">
            ...
            <div className="d-flex flex-column align-items-start">
              ...
              {info.docInfrl === 1 && (
                <CarpetaArchivoLink
                  carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                  archivo={`Infrl-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                />
              )}
            </div>
            <div className="d-flex flex-column align-items-start">
