          ...
          >
            <div className="d-flex flex-column gap-1">
              ...
              <div>
                ...
                <div className="d-flex flex-column align-items-start mt-2 ">
                  <label className="me-1">
                    <strong>Correo para la factura electrónica:</strong>
                  </label>
                  <div className="d-flex flex-row w-100">
                    <input
              ...
              <div className="w-100 mt-1">
                ...
                <div className="row row-cols-sm-2">
                  <div className="">
                    <div className="div-botons w-100">
                      <label className="fw-bold mt-1">
                        FORMATO DE VINCULACIÓN PROVEE:{" "}
                      </label>
                      <a
                        className=""
                        style={{ fontSize: 18 }}
                        href={VinculacionProveedor}
                        download="VINCULACION DE PROVEEDORES.pdf"
                      >
                        <FaFileDownload />
                        Descargar
                      </a>
                          ...
                          <div key={index} className="d-flex flex-row">
                            <div key={input.id} className="d-flex flex-row">
                              <input
                                ...
                                onChange={(e) => (
                                  handleFileChange(`Refcom${input.id + 1}`, e),
              ...
              <div className="row row-cols-sm-2">
                <div className="">
                  <div className="d-flex flex-column">
                    <label className="fw-bold mt-1 ">
                      ESTADOS FINAN. O CERTIFI. DE CONTADOR:{" "}
                    </label>
                    <div className="d-flex flex-column">
