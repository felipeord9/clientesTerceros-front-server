...
import { findAll } from "../../services/certificadoService";
...
export default function InfoCertificado() {
  ...
  useEffect(() => {
    ...
    if (data) {
      ...
      findAll(JSON.parse(data)).then(({ data }) => {
        setTerceros(data);
        setSuggestions(data);
        setLoading(false);
      });
  ...
  return (
    <div
      className="wrapper justify-content-center  h-100 w-100 m-auto"
      ...
      <div className="rounder-4">
        <div className="login-wrapper d-flex flex-column mt-5 pt-3">
          ...
          <div className="d-flex flex-column gap-2 h-100 ">
            <div
              className="d-flex flex-row rounded rounded-3 p-3 border border-2"
