    ...
    >
      <div className="rounder-4">
        ...
        >
            ...
            <section className="d-flex flex-row justify-content-between align-items-center mb-2">
              <div className="d-flex flex-column">
                <center>
                  <Fade cascade="true">
                    <label
                      className="fs-3 fw-bold m-1 ms-4 me-4 text-danger pb-2"
                      style={{ fontSize: 150 }}
                    >
                      <strong>persona NATURAL - pago a CRÉDITO</strong>
                    </label>
                  </Fade>
                  <hr className="my-1" />
                  {actualizar === "SI" && (
          ...
          <form
            className=""
            onSubmit={handleSubmit} /* onSubmit={handleOpenModal} */
          >
            <div className="bg-light rounded shadow-sm p-3 mb-3">
              <div className="d-flex flex-column gap-1">
                <div className="mb-2">
                  <label className="fw-bold mb-1" style={{ fontSize: 20 }}>
                  ...
                  <div className="d-flex flex-row mt-2">
                    ...
                    <div className="d-flex flex-row align-items-start w-100">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setDocument(JSON.parse(e.target.value))
                        }
                        required
                        disabled={actualizar === "" ? false : true}
                      >
                  ...
                  <div className="d-flex flex-row">
                    <div className="d-flex flex-column me-4 w-100">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setClasificacion(JSON.parse(e.target.value))
                        }
                        required
                      >
                        <option selected value="" disabled>
                ...
                <div className="d-flex flex-row mb-3">
                  ...
                  <div className=" pe-3" style={{ width: 255 }}>
                    ...
                    <select
                      ...
                      required
                      onChange={(e) =>
                        setResponsabilidad(JSON.parse(e.target.value))
                      }
                    >
                      <option selected value="" disabled>
                ...
                <div className="w-100 mt-1">
                  ...
                  <div className="d-flex flex-row ">
                    <div className="me-2 w-100">
                      <div className="d-flex flex-row w-100">
                        <label className="fw-bold mt-1" style={{ width: 280 }}>
                        ...
                        <a
                          ...
                          style={{ fontSize: 18 }}
                          href={NewVinCliente}
                          download="SALF-02 FORMATO  VINCULACION CLIENTES CON SOLICITUD DE CREDITO.pdf"
                        >
                          <FaFileDownload />
                          Descargar
                        </a>
                    ...
                    <div className="ms-2 w-100">
                      <div className="d-flex flex-row w-100">
                        ...
                        <a
                          className=""
                          style={{ fontSize: 18 }}
                          href={ComproAntiCorrup}
                          download="SALF-05 COMPROMISO ANTICORRUPCION.pdf"
                        >
                          <FaFileDownload />
                        ...
                        <div className="">
                          <div className="d-flex flex-row">
                            <IconButton
                              ...
                              className="rounded-5 d-flex justify-content-center align-items-center me-1"
                        ...
                        <div>
                          ...
                          <div className="form-control form-control-sm rounded rounded-2 mt-3 mb-3">
                            <label style={{ fontSize: 15 }}>
                              ...
                              Con NIT: <strong>{search.cedula}</strong>, en
                              donde nos arroja la siguiente información
                              financiera del cliente para la aprobación de
                              credito.
                            </label>
                          </div>
                          <center>
                          ...
                          <div className="d-flex flex-row w-100">
                            <div className="d-flex flex-column w-50 ">
                              <label>
                                <strong>Última actualización C.cio</strong>
                              </label>
                              <input
                                id="fechaRenovaCcio"
                            ...
                            <div
                              className="w-25 ps-3" /* style={{width:120}} */
                            >
                              <center>
                                <label>
                                  <strong>C.cio:</strong>
                          ...
                          <div className="d-flex flex-row w-100">
                            ...
                            <div className="d-flex flex-column w-50 me-2">
                              <label className="fw-bold mt-1 me-2">
                                VISTO BUENO DIRECCION COMERCIAL:{" "}
                              </label>
                              <div className=" rounded-2 pt-1">
                                <div className="d-flex flex-column">
                                  <select
                          ...
                          <div className="d-flex flex-column mt-2 w-50 me-2">
                            <label className="fw-bold mt-1 me-2">
                              VISTO BUENO DIRECTOR FINANCIERO:{" "}
                            </label>
                            <div className=" rounded-2 pt-1">
                              <div className="d-flex flex-column">
                                <select
                          ...
                          <div className="form-control form-control-sm  rounded rounded-2 mt-3 d-flex flex-row">
                            <label className="">
                              <strong>ANALISIS DE CREDITO:</strong> De acuerdo
                              al análisis Detallado de{" "}
                              <strong>
                                {search.primerApellido.toUpperCase()}{" "}
                                {search.segundoApellido.toUpperCase()}{" "}
                                {search.primerNombre.toUpperCase()}{" "}
                              ...
                              , presenta un nivel de Endeudamiento{" "}
                              <input
                              ...
                              ></input>
                              , como parte documental se recomienda dar un cupo
                              de{" "}
                              <input
                                type="number"
                                id="cupoRecomendado"
                                value={info.cupoRecomendado}
                                onChange={handlerChangeInfo}
                                style={{ width: 150, height: 25 }}
                              ></input>{" "}
                              a un plazo de
                              <input
                                type="number"
                                id="plazoRecomendado"
                                value={info.plazoRecomendado}
                                onChange={handlerChangeInfo}
                                style={{ width: 150, height: 25 }}
                              ></input>{" "}
                              dias, lo recomendado por el vendedor.
                            </label>
                          </div>
                          <hr></hr>
                          <div
                          ...
                          >
                            <center>
                              <h4 className="text-danger">
                                <strong>DATOS DE APROBACIÓN FINAL</strong>
                              </h4>
                            </center>
                            <div className="d-flex flex-row mb-2">
                              <div className="d-flex flex-row w-50 ">
                                <label style={{ fontSize: 20 }}>
                                  <strong>Cupo Aprobado:</strong>
                                </label>
                                <input
                                  style={{ width: 190 }}
                                  id="cupoAprovado"
                                  value={info.cupoAprovado}
                                  onChange={handlerChangeInfo}
                              ...
                              <div className="d-flex flex-row w-50">
                                <label style={{ fontSize: 20 }}>
                                  <strong>Plazo Aprobado:</strong>
                                </label>
                                <input
                                  style={{ width: 190 }}
                                  id="plazoAprovado"
                                  value={info.plazoAprovado}
                                  onChange={handlerChangeInfo}
                                  className="form-control form-control-sm ms-2"
                                ></input>
                              </div>
                          ...
                          <div className="mt-3 d-flex flex-row justify-content-end">
                            <button
                              onClick={(e) => (
                                handleSubmit(e), handleCloseModal(e)
                              )}
                              className="me-4"
                            >
                              REGISTRAR
