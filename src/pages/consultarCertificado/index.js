...
import { findByTercero } from "../../services/certificadoService";
              ...
              <div className="d-flex flex-column">
                <div className="m-0 p-0 d-flex justify-content-center align-items-center flex-column">
                  <div className="w-100 h-100 d-flex flex-row">
                    ...
                    <div className="d-flex w-50 justify-content-end">
                      <Button
                        style={{ height: 35 }}
                        onClick={(e) => navigate("/certificados")}
                        variant="contained"
                        className="d-flex justify-content-start"
                      >
                        Validar Envios
                        <RiVerifiedBadgeLine className="ms-1" />
                      </Button>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <center>
                    ...
                    <div className="d-flex flex-column">
                      <label className="" style={{ fontSize: 18 }}>
                        Para Generar uno o varios certificados, primero debes{" "}
                      </label>
                      <label style={{ fontSize: 18 }}>
                        {" "}
                        buscar el tercero por <strong>NIT</strong> o por{" "}
