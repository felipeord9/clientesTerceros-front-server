                ...
                <div className="">
                  ...
                  <div className=" rounded-2 ">
                    <div className="d-flex flex-row">
                      ...
                      {selectedFiles[1] && (
                        <div
                          className="div-botons justify-content-start pt-1 ps-2"
                          style={{ width: 70 }}
                        >
                          <a
                ...
                <div className="">
                  ...
                  <div className=" rounded-2">
                    <div className="d-flex flex-row">
                      ...
                      {selectedFiles[4] && (
                        <div
                          className="div-botons justify-content-start ps-1 pt-1"
                          style={{ width: 70 }}
                        >
                          <a
              ...
              <div className="d-flex flex-column mt-1 ">
                ...
                <div className="d-flex flex-row">
                  <input
                    ...
                    className="form-control form-control-sm border border-5 rounded-3 d-flex w-100"
                    accept=".pdf"
                  />
                  {selectedFiles[11] && (
                    <div
                      className="div-botons justify-content-start ps-4"
                      style={{ width: 70 }}
                    >
                      <a
