...
import { validarClienteId } from "../../services/clienteService";
...
export default function MostartPNCR() {
  ...
  return (
    ...
    >
      <div
        className=" login-wrapper shadow rounded-4 border border-3 p-2 pt-4 mt-5 pb-3 mb-5 overflow-auto"
      ...
      >
        ...
        >
          ...
          <button
            ...
            onClick={(e) => navigate("/editar/info/PNCR")}
            style={{
        ...
        >
          ...
          <div className="row row-cols-sm-4 mt-2 mb-2">
            ...
            <div className="d-flex flex-column align-items-start">
              ...
              {data ? (
                <TextOfBinary valor={data.docCtalnst}>
                  {info.docCtalnst}
                </TextOfBinary>
              ) : (
                <p>no hay nada</p>
            ...
            <div className="d-flex flex-column align-items-start">
              ...
              {data ? (
                <TextOfBinary valor={data.docPagare}>
                  {info.docPagare}
                </TextOfBinary>
              ) : (
                <p>no hay nada</p>
          ...
          <div className="row row-cols-sm-4 mt-2 mb-2">
            ...
            <div className="d-flex flex-column align-items-start">
              ...
              {data ? (
                <TextOfBinary valor={data.docFirdoc}>
                  {info.docFirdoc}
                </TextOfBinary>
              ) : (
                <p>no hay nada</p>
