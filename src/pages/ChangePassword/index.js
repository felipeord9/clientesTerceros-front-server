        ...
        Swal.fire({
          ...
          .then((result) => {
            if (result.isConfirmed) {
              ...
              setCargando(true);
              updateBitacora(user.email, info).then((data) => {
  ...
  return (
    ...
    >
      <div className="rounder-4">
        <div
          className="login-wrapper p-2 shadow-lg border-light mt-5 rounded-4 border border-3 bg-gradient d-flexjustify-content-between "
        ...
        >
          ...
          <Fade cascade>
            <h2 className="mt-1" style={{ color: "black" }}>
          ...
          <form onSubmit={handleSubmit} className="">
            <div className="input_group m-3 ">
              <input
                ...
                required
              />
              <label for="current" className="input_group_label">
                Contraseña actual
              </label>
              <span
            ...
            <div className="input_group m-3 d-flex flex-column">
              <input
                ...
                required
              />
              <label for="newPass" className="input_group_label">
                Nueva contraseña
              </label>
              <span
                className="position-absolute"
                ...
                style={{ right: 10, cursor: "pointer", fontSize: 25 }}
              >
                {mostrar ? <Bs.BsEye /> : <Bs.BsEyeSlash />}
              </span>
            </div>
            <div className="input_group m-3 d-flex flex-column">
              <input
                ...
                required
              />
              <label for="confirm" className="input_group_label">
