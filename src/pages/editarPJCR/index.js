    ...
    Swal.fire({
      ...
      .then(({ isConfirmed }) => {
        if (isConfirmed) {
          ...
          const folderName =
            search.cedula + "-" + search.razonSocial.toUpperCase();
          ...
          const originalFolderName =
            compare.cedula + "-" + compare.razonSocial.toUpperCase();
          ...
          updateCliente(search.id, body)
            .then(({ data }) => {
              ...
              de documento "${
                search.cedula
              }" se ha actualizado de manera satisfactoria`,
                  icon: "success",
                  position: "center",
  ...
  const TextOfBinary = ({ valor }) => {
    ...
    return (
      <label className="" style={{ color: labelColor, height: 18 }}>
        <strong className="">
          {nuevoTexto} {/* <img src={LogoPdf} style={{width:100}}></img> */}
        </strong>
      </label>
    );
  };
          ...
          >
            <div className="d-flex flex-column gap-1">
              ...
              <div>
                ...
                <div className="d-flex flex-column align-items-start mb-3 w-100">
              ...
              <hr className="my-1" />
              <div>
                <label className="fw-bold" style={{ fontSize: 22 }}>
                  SUCURSAL
                </label>
                <div className="row row-cols-sm-2">
                  <div className="d-flex flex-column align-items-start">
                ...
                <div className="d-flex flex-column align-items-start mb-3">
                  ...
                  <div className="d-flex flex-row w-100"> 
                    <input
                      ...
                      onChange={(e) => (
                        handlerChangeSearch(e), manejarCambioCorreo(e)
                      )}
                      placeholder="Campo obligatorio"
                    ></input>
                    <p className="ps-3" style={{ color: colorSpan }}>
                      <strong>{mensajeValidacion}</strong>
                    </p>
                  </div>
                </div>
                <hr className="my-1" />
                <label className="fw-bold mt-2" style={{ fontSize: 22 }}>
                ...
                <div className="mt-3">
                  ...
                  <div className="row row-cols-sm-2 mt-2 mb-4">
                    <div className="d-flex flex-column align-items-start">
                ...
                <div className="row row-cols-sm-2 ">
                    ...
                    <div className="d-flex flex-column">
                      <div className="d-flex flex-column">
                        ...
                        {search.docVinculacion === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Vinculacion-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                  ...
                  <div className="">
                    ...
                    <div className="d-flex flex-column">
                      <div className="d-flex flex-column">
                        <TextOfBinary
                          valor={search.docComprAntc}
                        ></TextOfBinary>
                        {search.docComprAntc === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`ComprAntc-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docCtalnst === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`CtaInst-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docPagare === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Pagare-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docRut === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Rut-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>{" "}
                  ...
                  <div className="d-flex flex-column mt-2">
                    <div className="d-flex flex-column">
                      ...
                      {search.docCcio === 1 && (
                        <CarpetaArchivoLink
                          carpeta={`${search.cedula}-${search.razonSocial}`}
                          archivo={`Ccio-${search.razonSocial}.pdf`}
                        />
                      )}
                    </div>
                    <div className=" rounded-2 pt-1">
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docCrepL === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`CrepL-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docEf === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Ef-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docCvbo === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Cvbo-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docRefcom === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Refcom-${search.razonSocial}.pdf`}
                          />
                        )}
                        {search.docRefcom2 === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Refcom2-${search.razonSocial}.pdf`}
                          />
                        )}
                        {search.docRefcom3 === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Refcom3-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docInfemp === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Infemp-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docInfrl === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Infrl-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docFirdoc === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Firdoc-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docCerBan === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Certban-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        {search.docOtros === 1 && (
                          <CarpetaArchivoLink
                            carpeta={`${search.cedula}-${search.razonSocial}`}
                            archivo={`Otros-${search.razonSocial}.pdf`}
                          />
                        )}
                      </div>
                    </div>
                    <div className=" rounded-2 pt-1">
                      <div className="d-flex flex-row">
                        ...
                        {selectedFiles[19] && (
                          <div className=" pt-1 ps-2" style={{ width: 50 }}>
                            <a
                              href={URL.createObjectURL(selectedFiles[19])}
                              target="_blank"
                              rel="noopener noreferrer"
                            >
                              <FaEye />
