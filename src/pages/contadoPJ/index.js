...
export default function ContadoPersonaJuridica() {
  ...
  const [docComprAntc] = useState(0);
  const [docCtaInst] = useState(0);
  const [docPagare] = useState(0);
  const [docRut, setDocRut] = useState(0);
  const [docCcio] = useState(0);
  const [docCrepL] = useState(0);
  const [docEf] = useState(0);
  const [docRefcom] = useState(0);
  const [docCvbo] = useState(0);
  const [docFirdoc] = useState(0);
  const [docInfemp, setDocInfemp] = useState(0);
  const [docInfrl, setDocInfrl] = useState(0);
  const [docOtros, setDocOtros] = useState(0);
  const [docCerBan] = useState(0);
  const [docValAnt] = useState(0);
                ...
                <center>
                  <Fade cascade="true">
                    <h1
                      ...
                      style={{ fontSize: 150 }}
                    >
                      <strong>persona JURÍDICA - pago a CONTADO</strong>
                    </h1>
                  </Fade>
                  <hr className="my-1" />
                  {actualizar === "SI" && (
              ...
              <div className="d-flex flex-column gap-1">
                <div>
                  ...
                  <div className="d-flex flex-row">
                    ...
                    <div
                      className="d-flex flex-column align-items-start w-100 ps-3"
                      style={{ fontSize: 18 }}
                    >
                    ...
                    <div className="d-flex flex-row mt-2">
                      ...
                      <div className="d-flex flex-row w-100">
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setCiudad(JSON.parse(e.target.value))
                          }
                        >
                          <option selected value="" disabled>
                ...
                <div className="w-100 mt-1">
                    ...
                    <div className="me-2 w-50">
                      <div className="d-flex flex-row w-100">
                        ...
                        <a
                          ...
                          style={{ fontSize: 18 }}
                          href={NewFormCliente}
                          download="SALF-11 FORMATO  VINCULACION CLIENTES.pdf"
                        >
                          <FaFileDownload />
                          Descargar
                        </a>
                  ...
                  <div className="d-flex flex-row">
                    ...
                    <div className="d-flex flex-column ">
                      <label className="fw-bold mt-1 me-2 ms-2">
                        INFOLAFT EMPRESA:{" "}
                      </label>
                      <div className=" rounded-2 pt-1">
                        <div className="d-flex flex-row">
