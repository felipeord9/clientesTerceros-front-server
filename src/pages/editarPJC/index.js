...
export default function EditarPJC() {
  ...
  const generarEnlace = (e) => {
    ...
    try {
      const nombreFolder = fetch(
        `${config.apiUrl2}/uploadMultiple/archivo/${nombreArchivo}`,
        {
          method: "post",
          headers: {
                  ...
                  <div className="d-flex flex-row">
                    <div className="d-flex flex-column align-items-start w-100">
                      ...
                      <input
                        id="cedula"
                        type="number"
                        className="form-control form-control-sm w-100 d-flex"
                        min={10000}
                        max={999999999}
                        required
                        disabled
                  ...
                  <div className="d-flex flex-column mt-2">
                    ...
                    <div className=" rounded-2 pt-2">
                      <div className="d-flex flex-column">
                        ...
                        {selectedFiles[4] && (
                          <div
                            className="d-flex justify-content-start pt-1 "
                            style={{ width: 50 }}
                          >
                            <a
