  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: "white", userSelect: "none", width: 870 }}
      >
        <center>
            ...
            <div className="d-flex flex-column">
              <center>
                <Fade cascade="true">
                  ...
                  >
                    <strong>
                      PROVEEDOR MCIA Y CONVENIOS - persona JURÍDICA
                    </strong>
                  </label>
                </Fade>
                <hr className="my-1" />
          ...
          <div className="bg-light rounded shadow-sm p-3 mb-3">
            <div className="d-flex flex-column gap-1">
              ...
              <div className="d-flex flex-row">
                ...
                <div
                  className="ms-2  d-flex flex-column align-items-start w-100"
                  style={{ fontSize: 18 }}
                >
                  ...
                  <div className="me-2 w-100">
                    <div className="d-flex flex-row w-100">
                      ...
                      <a
                        ...
                        style={{ fontSize: 18 }}
                        href={NewFormProvee}
                        download="SALF-01 FORMATO VINCULACION DE PROVEEDORES.pdf"
                      >
                        <FaFileDownload />
                        Descargar
                      </a>
                  ...
                  <div className=" rounded-2 pt-1">
                    <div className="d-flex flex-row">
                      ...
                      {selectedFiles[13] && (
                        <div className=" pt-1 ps-2" style={{ width: 50 }}>
                          <a
                            href={URL.createObjectURL(selectedFiles[13])}
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            <FaEye />
