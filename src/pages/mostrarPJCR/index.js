    ...
    return(
      ...
      >
        <div className="w-100 d-flex flex-row" >
          ...
          <button onClick={(e)=>navigate('/editar/info/PJCR')} style={{height:55,width:150}}><CiEdit />Actualizar</button>
      ...
      <div className="d-flex flex-row mt-2 mb-2">
                <div className="d-flex flex-column align-items-start w-25 me-1" >
