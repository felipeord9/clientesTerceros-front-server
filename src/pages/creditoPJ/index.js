      ...
      .then(({ isConfirmed }) => {
        if (isConfirmed) {
          ...
          const sucur = {
            ...
            codigoSucursal: 1,
            nombreSucursal:
              search.razonSocial.toUpperCase() +
              " - " +
              search.nombreSucursal.toUpperCase(),
        ...
        <center>
          <section className="d-flex flex-row justify-content-between align-items-center mb-2">
            <div className="d-flex flex-column">
              <center>
                <Fade cascade="true">
                  <h1 className="fs-3 fw-bold m-1 ms-4 me-4 text-danger pb-2">
                    <strong>persona JURÍDICA - pago a CRÉDITO</strong>
                  </h1>
                </Fade>
                <hr className="my-1" />
                {actualizar === "SI" && (
              ...
              <div className="w-100 mt-1">
                ...
                <div className="d-flex flex-row ">
                  <div className="me-2 w-100">
                    <div className="d-flex flex-row w-100">
                      <label
                        className="fw-bold mt-1 w-75" /* style={{width:200}} */
                      >
                  ...
                  <div className="ms-2 w-100">
                    <div className="d-flex flex-row w-100">
                      <label className="fw-bold mt-1 w-75">
                    ...
                    <div className=" rounded-2 pt-1">
                      <div className="d-flex flex-row">
                        ...
                        {selectedFiles[14] && (
                          <div className=" pt-1 ps-2" style={{ width: 50 }}>
                            <a
                              href={URL.createObjectURL(selectedFiles[14])}
                              target="_blank"
                              rel="noopener noreferrer"
                            >
                              <FaEye />
