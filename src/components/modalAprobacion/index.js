    ...
    >
      ...
      >
        <Modal.Header>
          <center>
            <Modal.Title
              className="text-danger justify-content-center w-100"
              style={{ fontSize: 40 }}
            >
              <strong className="w-100 justify-content-center">
                {" "}
                Aprobación
              </strong>
            </Modal.Title>
        ...
        <Modal.Body className="p-2">
          <div className="m-2 h-100">
            <form>
              <div>
                <div>
                  <label className="fw-bold" style={{ fontSize: 19 }}>
                    Comentarios
                  </label>
                  <textarea
                    id="comentarios"
        ...
        <Modal.Footer>
          <div className="d-flex justify-content-center gap-2 mt-3 ">
            <button className="me-4" type="submit" onClick={handlesubmit}>
              Guardar
            </button>
            <Button
              variant="secondary"
