    ...
    >
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title
            className="text-danger d-flex flex-row w-100 justify-content-center text-align-center"
            style={{ fontSize: 40 }}
          >
            <center>
              ...
              <div>
                ...
                <div className="d-flex flex-row">
                  ...
                  {(info.tipoFormulario === "PMJ" ||
                    info.tipoFormulario === "PMN" ||
                    info.tipoFormulario === "PS" ||
                    info.tipoFormulario === "PVJ" ||
                ...
                {(info.tipoFormulario === "PVN" ||
                  ...
                  >
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docRut === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Rut-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                        </label>
                      )}
                    </div>
                    <div className="w-100 ms-3 d-flex flex-column">
                      ...
                      {info.docInfemp === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Infemp-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                    ...
                    <div className="w-100 ms-3 d-flex flex-column">
                      ...
                      {info.docOtros === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Otros-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                    ...
                    {(info.tipoFormulario === "PNC" ||
                      ...
                      <div className="w-100 ms-3 d-flex flex-column">
                        ...
                        {info.docVinculacion === 1 ? (
                          <CarpetaArchivoLink
                            carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                            archivo={`Vinculacion-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                          />
                        ) : (
                          <label className="text-danger">
                            <strong>No fue cargado</strong>
                    ...
                    {(info.tipoFormulario === "PNCR" ||
                      ...
                      <div className="w-100 ms-3 d-flex flex-column">
                        ...
                        {info.docComprAntc === 1 ? (
                          <CarpetaArchivoLink
                            carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                            archivo={`ComprAntc-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                          />
                        ) : (
                          <label className="text-danger">
                            <strong>No fue cargado</strong>
                  ...
                  >
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docCcio === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Ccio-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                    ...
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docCerBan === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Certban-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                    ...
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docCrepL === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`CrepL-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                    ...
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docEf === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Ef-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                    ...
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docRefcom === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Refcom-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                      ...
                      {info.docRefcom2 === 1 && (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Refcom2-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      )}
                      {info.docRefcom3 === 1 && (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Refcom3-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      )}
                    </div>
                  </div>
                  ...
                  >
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docCtalnst === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`CtaInst-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                    ...
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docPagare === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Pagare-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                    ...
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docFirdoc === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Firdoc-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                    ...
                    <div className="w-100 d-flex flex-column">
                      <label className="fw-bold">
                        Carta Visto Bueno Admin.
                      </label>
                      {info.docCtalnst === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.primerApellido}-${info.segundoApellido}-${info.primerNombre}-${info.otrosNombres}`}
                          archivo={`Cvbo-${info.primerApellido} ${info.segundoApellido} ${info.primerNombre} ${info.otrosNombres}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                  ...
                  {info.tipoFormulario === "PJCR" && (
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docCtalnst === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.razonSocial}`}
                          archivo={`CtaInst-${info.razonSocial}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                  ...
                  {info.tipoFormulario === "PJCR" && (
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docPagare === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.razonSocial}`}
                          archivo={`Pagare-${info.razonSocial}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                  ...
                  {info.tipoFormulario === "PJCR" && (
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docCvbo === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.razonSocial}`}
                          archivo={`Cvbo-${info.razonSocial}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
                  ...
                  {info.tipoFormulario === "PJCR" && (
                    <div className="w-100 d-flex flex-column">
                      ...
                      {info.docFirdoc === 1 ? (
                        <CarpetaArchivoLink
                          carpeta={`${info.cedula}-${info.razonSocial}`}
                          archivo={`Firdoc-${info.razonSocial}.pdf`}
                        />
                      ) : (
                        <label className="text-danger">
                          <strong>No fue cargado</strong>
        ...
        {info.aprobado === "1" && (
          <center>
            <Modal.Footer className="d-flex justify-content-center">
              <label style={{ color: "green" }} className="fw-bold">
