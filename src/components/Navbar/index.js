        ...
        >
          <div className="d-flex flex-row justify-content-between w-100 h-100 px-3 shadow">
            ...
            <div className="d-flex flex-row align-items-center">
              ...
              >
                <span
                  className="text-light text-nowrap m-0"
                  style={{ fontSize: 16 }}
                >
                  {user.name}
                </span>
              ...
              >
                <center>
                  <p className="fw-bold mt-1 mb-1">{user.role}</p>
                  ...
                  <MenuItem style={{ userSelect: "none" }}>
                    <button className="d-flex w-100" onClick={handleOpenModal}>
                      ...
                      <label className="ms-1" style={{ fontSize: 15 }}>
                        CERRAR SESIÓN
                      </label>
                    </button>
                    <Modal
                      ...
                      <Box sx={style}>
                        <center>
                          ...
                          <div className="d-flex flex-row">
                            {/* <hr className="my-1" /> */}
                            <h3 id="parent-modal-title" className=" d-flex">
                              ¿Está segur@ que desea cerrar la sección?
                            </h3>
                          </div>
                          <div className="d-flex flex-row justify-content-center">
                            <div onClick={handleClose}>
                              <button
                                className="m-4"
                                onClick={(e) => (handleExit(e), logout(e))}
                                style={{ fontSize: 18 }}
                              >
                                <strong>YES</strong>
                              </button>
                            ...
                            <div>
                              <Button
                                variant="contained"
                                color="primary"
                                style={{ width: 90, height: 55, fontSize: 22 }}
                                className="m-4"
